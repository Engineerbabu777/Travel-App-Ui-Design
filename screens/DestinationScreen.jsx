  ...
  return (
    <View className="bg-white flex-1">
        ...
        <SafeAreaView className={"flex-row justify-between items-center w-full absolute " + topMargin}>
            ...
            >
                <VectorIcon type='AntDesign' name="left" size={wp(7)} strokeWidth={4} color="white" />
            </TouchableOpacity>
            <TouchableOpacity
                ...
                style={{backgroundColor: 'rgba(255,255,255,0.5)'}}
            >
                <VectorIcon name="heart" type="Entypo" size={wp(7)} strokeWidth={4} color={isFavourite? "red": "white"} />
            </TouchableOpacity>
        </SafeAreaView>
            ...
            <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
                ...
                <View className="flex-row justify-between mx-1">
                    <View className="flex-row space-x-2 items-start">
                        <VectorIcon name="clock"  type="Entypo" size={wp(7)} color="skyblue" />
                    ...
                    <View className="flex-row space-x-2 items-start">
                        <VectorIcon type="Entypo" name="location" size={wp(7)} color="#f87171" />
                        <View className="flex space-y-2">
                    ...
                    <View className="flex-row space-x-2 items-start">
                        <VectorIcon type="Entypo" name="sun" size={wp(7)} color="orange" />
                        <View className="flex space-y-2">
